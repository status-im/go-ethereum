...
func (tx *OptimismDepositTx) encode(*bytes.Buffer) error {
	panic("encode called on OptimismDepositTx")
}

func (tx *OptimismDepositTx) decode([]byte) error {
	panic("decode called on OptimismDepositTx)")
}

func (tx *OptimismDepositTx) effectiveGasPrice(dst *big.Int, baseFee *big.Int) *big.Int {
	// TODO which gas price to use?
	return dst
}
